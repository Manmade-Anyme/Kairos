...
* **Output Display:** The alert output includes the absolute **ATM IV** and the **IV Change %** alongside the trend status (e.g., `+0.48 — IV expanding (DTE≤1) | ATM IV: 10.82 | IV%: +42.96%`).
